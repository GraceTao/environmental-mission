   ...
   return (
      <div>
         ...
         <Typography sx={{ p: 2, fontSize: { sm: "1rem", lg: "1.2rem" } }}>
            ...
            Parts of an EIS:
            <ol>
               <li>An Introduction including a statement of the Purpose and Need of the Proposed Action.</li>
               <li>A description of the Affected Environment.</li>
               <li>A Range of Alternatives to the proposed action, such as what would happen if no action was taken or the least environmentally harmful action. This is usually the most scrutinized part.</li>
               <li>An analysis of the environmental impacts of each of the possible alternatives, including impacts on threatened or endangered species, air and water quality, and historical sites.</li>
            </ol>
            <br />
         </Typography>
         <Typography sx={{ p: 2, fontSize: { sm: "1rem", lg: "1.2rem" } }} align="center">
