...
const Clue1 = () => {
  ...
  const handleSolve = () => {
    if(parseInt(inputs.totalAreas) == 4 && parseInt(inputs.definiteViolations)==1 && parseInt(inputs.furtherInvestigation)==3){
      ...
      <div>
          ...
          <div class="container">
            ...
            <div class="violations">
              <class1>
                <button name="pesticides" onClick={() => setPesticide(!openPesticide)}>
                  {openPesticide && (
                    <Reveal
                      color = "#f7d2f4"
            ...
            <div class="vertical">
              ...
              <button name="emission">
                <img src={Emission} alt="Emission" onClick={() => setEmission(!openEmission)} />
          ...
          {! solved ? (
          <div>
          <Button name="report" variant="contained" color="secondary" onClick={() => setReport(!openReport)}>
              <txt>Report</txt>
            </Button>
            <Submit
            open={openReport}
...
<Dialog open={solved} onClose={() => setSolved(!solved)}>
               <DialogContent sx={{ backgroundColor: "0FBED8" }}>
                  <Typography
                     ...
                     align="center"
                  >
                     <b>Congratulations!</b> You have successfully analyzed this site
                  </Typography>
                  <br />
                  <Typography
