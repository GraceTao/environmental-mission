...
export default function ImageCredits() {
   ...
   return (
      <Box display="flex" flexDirection="row" justifyContent="flex-end">
         <Button onClick={handleClick} sx={{color: "blue", fontWeight: "bold"}}>Image Credits</Button>
         <Popper id={id} open={open} anchorEl={anchorEl} sx={{backgroundColor: "white"}}>
            <a href="https://commons.wikimedia.org/wiki/File:Secchi_disk_pattern.svg">
               Secchi disk
            </a>
            <br />
            <a href="https://icons8.com/icon/o3IfzNL0r7Ol/bacteria" >
               Bacteria
            </a>
            <br />
            ...
            <a href="https://icons8.com/icon/5kRwCn47X46Y/oxygen">
               Oxygen
            </a><br/>
