                  ...
                  {image ? (
                     ...
                     >
                        ...
                        >
                           ...
                           <br />
                           <br />
                           I am part of a team that is designing an office
                           building (roughly the shape of a rectangular prism).
                           In order to submit a formal request, I need to know
                           the dimensions of this space. I would like to
                           maximize the dimensions, as I want this to be a large
                           space. However, I am struggling to wrap my head
                           around the environmental restrictions of this area.
                           <br />
                           <br />
                           An image of the area is attached with the location of
                           the potential building marked with an X. I've also
                           attached the rules we must adhere to. Would you be
               ...
               <Dialog open={solved} onClose={() => setSolved(!solved)}>
                  <DialogContent>
                     <Typography
                        ...
                        align="center"
                     >
                        <b>Congratulations!</b> You have correctly determined
                        the maximum dimensions of the building that comply with
                        regulations.
                     </Typography>
                     <br />
                     <Typography
         ...
         <Box position="absolute" bottom={0} right="5px">
            {openCreds && (
               <Box sx={{ backgroundColor: "white" }}>
                  <a href="https://commons.wikimedia.org/wiki/File:NYS_Forest_Preserve_sign.jpg">
                     Forest preserve sign
                  </a>
                  <br />
                  <a href="https://creazilla.com/nodes/3152007-wind-turbine-clipart">
                     Wind turbine
                  </a>
               </Box>
            )}
            <Button
               onClick={() => setOpenCreds(!openCreds)}
               sx={{ color: "black" }}
            >
               Image Credits
            </Button>
